...
export const uiText = {
  'zh-cn': {
    nav: { home: '首页', journey: '开发历程', security: '安全白皮书', download: '下载', support: '赞助支持', about: '关于' },
    switchLanguage: 'English',
    skipToContent: '跳到正文',
  },
  en: {
    nav: { home: 'Home', journey: 'Development', security: 'Security', download: 'Download', support: 'Sponsor', about: 'About' },
    switchLanguage: '中文',
